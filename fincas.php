...
<div id="fincas" class="container">
	...
	<div class="row">
		<div class="col-xs-12 align-right">
			...
			<a href="" data-toggle="modal" data-target="#ventanaFinca" class="btn-mas"><span>Nueva Parcela</span></a>	
			<?php include(ABSPATH . 'templates/explotaciones/registroFinca.php');?>
		</div>
	</div>
	<div class="row">
		<div class="col-xs-12 titulo_tabla">
			<h3>Nombre de la finca <a href="" style="color: #227A4B; margin-left: 20px;" data-toggle="modal" data-target="#editarExplotacion" class="glyphicon glyphicon-pencil"></a> 
			<a href="" style="color: #227A4B; margin-left: 4px;" data-toggle="modal" data-target="#eliminarExplotacion"  class="glyphicon glyphicon-remove"></a></h3>
		...
		<table class="table">
			...
			<tbody>
					<tr>
						...
						<td class="edit-col"><a href="" data-toggle="modal" data-target="#editarExplotacion" class="glyphicon glyphicon-pencil"></a><?php include(ABSPATH . 'templates/fincas/editarParcela.php');?></td>
							<td class="remove-col"><a href="" data-toggle="modal" data-target="#eliminarExplotacion"  class="glyphicon glyphicon-remove"></a><?php include(ABSPATH . 'templates/fincas/eliminarParcela.php');?></td>	
					</tr>
			</tbody>
		</table>
	</div>
