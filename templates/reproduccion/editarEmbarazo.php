	...
	<div class="modal fade align-left" id="editarEmbarazo">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>?accion=editar_embarazo">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title">Editar un embarazo</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
						<label for="id_embarazo">Id</label> <input type="text" name="id_embarazo" class="form-control" id="id_embarazo" disabled>
					</div>
					<div class="form-group">
