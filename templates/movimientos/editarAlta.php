	...
	<div class="modal fade align-left" id="editarAlta">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>?accion=editar_alta">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title">Editar una alta</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
						<label for="id_alta">Id</label> <input type="text" name="id_alta" class="form-control" id="id_alta" disabled>
					</div>
					<div class="form-group">
